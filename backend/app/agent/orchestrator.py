...
def _build_catalog_block(catalog_text: str) -> str:
    ...
    return (
        ...
        "- O preço/lote que você divulgar DEVE vir da linha cujo produto, gramatura e "
        "embalagem batem EXATAMENTE com o que o cliente pediu; nunca substitua pelo valor "
        "de outra linha (ex.: não passe o valor do Microlote quando o cliente perguntou do "
        "Clássico).\n"
