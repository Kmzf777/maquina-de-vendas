def build_outbound_first_turn_context(
    ...
    return (
        ...
        f"motivo, e sem motivo o lead fica sem entender o que você quer. Sem telemarketing. "
        ...
        f"'fico à disposição' — o lead frio não tem pedido nenhum a fazer, e devolver a "
        f"condução pra ele mata a conversa (falha real 13/07).\n"
