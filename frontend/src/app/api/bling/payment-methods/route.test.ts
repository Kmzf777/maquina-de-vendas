...
describe("GET /api/bling/payment-methods", () => {
  it("repassa o account para o backend", async () => {
    ...
    await GET(new Request("http://x/api/bling/payment-methods?account=secundaria"));
  ...
  it("nao inventa account quando o chamador nao informa (backend usa o default)", async () => {
    ...
    await GET(new Request("http://x/api/bling/payment-methods"));
