  ...
  return (
    <div className="space-y-5 mb-6">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
        <div className="bg-white border border-[#dedbd6] rounded-[8px] p-4 md:p-5">
          <p className="text-[11px] uppercase tracking-[0.6px] text-[#7b7b78] mb-3">Disparos Feitos</p>
          <p style={{ letterSpacing: '-1.5px' }} className="text-[32px] md:text-[48px] font-normal text-[#111111] leading-none">{stats.disparosFeitos ?? 0}</p>
        ...
        <div className="bg-white border border-[#dedbd6] rounded-[8px] p-4 md:p-5">
          ...
          <p style={{ letterSpacing: '-1.5px' }} className={`text-[32px] md:text-[48px] font-normal leading-none ${
        ...
        <div className="bg-white border border-[#dedbd6] rounded-[8px] p-4 md:p-5">
          ...
          <p style={{ letterSpacing: '-1.5px' }} className="text-[32px] md:text-[48px] font-normal text-[#111111] leading-none">{stats.activeCadences ?? 0}</p>
          <p className="text-[13px] text-[#7b7b78] mt-2">configuradas</p>
        </div>
        <div className="bg-white border border-[#dedbd6] rounded-[8px] p-4 md:p-5 col-span-2 md:col-span-1">
          <p className="text-[11px] uppercase tracking-[0.6px] text-[#7b7b78] mb-3">Responderam</p>
          <p style={{ letterSpacing: '-1.5px' }} className="text-[32px] md:text-[48px] font-normal text-[#0bdf50] leading-none">{stats.respondedCount ?? 0}</p>
