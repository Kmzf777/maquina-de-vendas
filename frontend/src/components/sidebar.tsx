...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      // Logo depois de "Painel de Vendas": o orçamento é o passo ANTES da venda,
      // mas a proximidade que importa é com a tela que ele espelha — mesmos
      // filtros, mesmos quatro cards, mesma tabela. Quem acabou de olhar as
      // vendas do mês encontra as propostas do mês na linha de baixo.
      {
        href: "/orcamento",
        label: "Orçamentos",
      ...
      },
      {
        href: "/produtos",
        label: "Produtos",
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" /></svg>,
      },
      {
        href: "/busca",
        label: "Busca",
    ...
    items: [
      {
        ...
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h12M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A12.061 12.061 0 0116.5 7.605" /></svg>,
        roles: ["admin"],
      },
      {
        href: "/estatisticas",
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-3 px-3 py-2 rounded-[6px] text-[13px] transition-all duration-150 ${
                      isActive
                        ...
                        : "text-[#313130] hover:bg-[#dedbd6]/60 hover:text-[#111111]"
                    }`}
                  >
                    {item.icon}
                    {item.label}
